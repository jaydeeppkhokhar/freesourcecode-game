(function pet_cat() {
  ...
  // please use data-neko="true" on your A elements that link to another site with pet_cat-webring.js instead of this
  ...
  try {
    ...
    console.error("pet_cat.js: failed to parse query params.");
    console.error(e);
  }
  ...
  function init() {
    ...
    let nekoFile = "./pet-cat/pet_cat.gif"
